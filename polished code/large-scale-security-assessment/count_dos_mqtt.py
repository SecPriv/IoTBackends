...
for backend, v in FILE_2024.items():
    ...
    if 'update_sep_2023' in v and 'DoS' in v['update_sep_2023'] or (('vulnerability_classes' in v and 'DoS' in v['vulnerability_classes']) and v['status_sep_2023'] == 'online' and 'update_sep_2023' not in v):
