...
backends_vulnerable_ampl_2022 = set()
backends_vulnerable_server_2022 = set()
countries_zyxel_2022 = {}
providers_ampl_2022 = {}
...
for backend, v in FILE_2024.items():
    try:
        ...
        country = None
    if 'vulnerability_classes' in v and 'DoS' in v['vulnerability_classes']:
        backends_vulnerable_server_2022.add(backend)

    if 'amplification_vulnerability' in v['vulnerability_classes']:
        backends_vulnerable_ampl_2022.add(backend)
        add_element_to_map(v['provider'], providers_ampl_2022)

        if 'ZYXEL_000' in v['vulnerability_classes']['amplification_vulnerability']['CVEs']:
            add_element_to_map(country, countries_zyxel_2022)
...
print(len(backends_vulnerable_server_2022))
# print(providers_2022)
# print(countries_2022)

print(len(backends_vulnerable_ampl_2022))
print(countries_zyxel_2022)
print(providers_ampl_2022)

print(len(set.union(backends_vulnerable_ampl_2022, backends_vulnerable_server_2022)))
